...
const EXAMPLE_PROMPTS = [
  "יש לי 10 עובדים ו-3 משמרות ביום: בוקר, צהריים, ערב. בכל משמרת בוקר צריך אחראי וקופאי. תבנה לי סידור לשבוע הבא.",
  "כמה משמרות לא שובצו בסידור האחרון ולמה?",
  "תראה לי את הגדרות המשמרות והתפקידים הנוכחיים שלי.",
];
